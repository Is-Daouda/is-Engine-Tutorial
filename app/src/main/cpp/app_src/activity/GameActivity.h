...
////////////////////////////////////////////////////////////
        ...
        case is::DisplayOption::GAME_LEVEL:
            m_gameScene = std::make_shared<GameLevel>(gameSysExt.m_window, getView(), m_surface, gameSysExt);
        break;

        case is::DisplayOption::GAME_MENU:
            m_gameScene = std::make_shared<GameMenu>(gameSysExt.m_window, getView(), m_surface, gameSysExt);
        break;

        case is::DisplayOption::GAME_OVER:
            m_gameScene = std::make_shared<GameOver>(gameSysExt.m_window, getView(), m_surface, gameSysExt);
        break;

        // example
        // case is::DisplayOption::YOUR_SCENE:
        //    m_gameScene = std::make_shared<YourScene>(gameSysExt.m_window, getView(), m_surface, gameSysExt);
        // break;
